...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        print("This application requires command line arguments.")
        print("Usage:")
        print("  python main.py manual    # Manual mode")
        print("  python main.py ai        # AI mode with default task")
        print("  python main.py ai 'red cup'  # AI mode with custom task")
        return
